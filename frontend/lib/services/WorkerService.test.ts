...
describe('WorkerService', () => {
    ...
    it('should throw error if sharing key is not between 0 and 100', async () => {
        ...
        await expect(service.create(invalidWorker as any)).rejects.toThrow(/Validation failed.*sharingKey/);
    });
    ...
    it('should validate email format during creation', async () => {
        ...
        await expect(service.create(invalidWorker as any)).rejects.toThrow(/Validation failed.*email/);
    });
    ...
    it('should validate phone format during creation', async () => {
        ...
        await expect(service.create(invalidWorker as any)).rejects.toThrow(/Validation failed.*phone/);
    });
