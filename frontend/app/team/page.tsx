...
const workers = [
    { id: 1, name: "Orphelia", avatar: "O", status: "Active", sharingKey: 70, totalRevenue: "€45,830", totalSalary: "€32,081", monthRevenue: "€4,990", monthSalary: "€3,423", yearRevenue: "€52,450", yearSalary: "€36,715", clients: 187, rating: 4.9, services: 203, color: "from-purple-500 to-purple-700" },
    { id: 2, name: "Team Member 2", avatar: "W2", status: "Active", sharingKey: 55, totalRevenue: "€38,650", totalSalary: "€21,258", monthRevenue: "€3,050", monthSalary: "€2,000", yearRevenue: "€41,230", yearSalary: "€22,577", clients: 156, rating: 4.8, services: 178, color: "from-pink-500 to-pink-700" },
    { id: 3, name: "Team Member 3", avatar: "W3", status: "Active", sharingKey: 60, totalRevenue: "€42,200", totalSalary: "€25,320", monthRevenue: "€3,430", monthSalary: "€2,552", yearRevenue: "€38,450", yearSalary: "€33,330", clients: 165, rating: 4.7, services: 189, color: "from-orange-500 to-orange-700" },
    { id: 4, name: "Team Member 4", avatar: "W4", status: "Active", sharingKey: 50, totalRevenue: "€35,420", totalSalary: "€17,710", monthRevenue: "€2,980", monthSalary: "€1,690", yearRevenue: "€34,380", yearSalary: "€17,180", clients: 142, rating: 4.6, services: 165, color: "from-teal-500 to-teal-700" },
    { id: 5, name: "Team Member 5", avatar: "W5", status: "Inactive", sharingKey: 55, totalRevenue: "€28,340", totalSalary: "€15,587", monthRevenue: "€2,750", monthSalary: "€1,815", yearRevenue: "€31,200", yearSalary: "€17,160", clients: 118, rating: 4.5, services: 134, color: "from-blue-500 to-blue-700" },
    { id: 6, name: "Team Member 6", avatar: "W6", status: "Active", sharingKey: 65, totalRevenue: "€39,850", totalSalary: "€25,903", monthRevenue: "€2,340", monthSalary: "€1,270", yearRevenue: "€28,980", yearSalary: "€16,685", clients: 171, rating: 4.8, services: 192, color: "from-indigo-500 to-indigo-700" },
    { id: 7, name: "Team Member 7", avatar: "W7", status: "Active", sharingKey: 55, totalRevenue: "€32,450", totalSalary: "€17,848", monthRevenue: "€2,320", monthSalary: "€1,276", yearRevenue: "€28,490", yearSalary: "€14,540", clients: 124, rating: 4.6, services: 145, color: "from-rose-500 to-rose-700" },
    { id: 8, name: "Team Member 8", avatar: "W8", status: "Active", sharingKey: 60, totalRevenue: "€29,870", totalSalary: "€17,922", monthRevenue: "€1,960", monthSalary: "€676", yearRevenue: "€22,340", yearSalary: "€9,170", clients: 112, rating: 4.4, services: 128, color: "from-amber-500 to-amber-700" },
    { id: 9, name: "Team Member 9", avatar: "W9", status: "Inactive", sharingKey: 50, totalRevenue: "€24,680", totalSalary: "€12,340", monthRevenue: "€1,850", monthSalary: "€1,000", yearRevenue: "€24,600", yearSalary: "€13,240", clients: 98, rating: 4.3, services: 108, color: "from-cyan-500 to-cyan-700" },
    { id: 10, name: "Team Member 10", avatar: "W10", status: "Active", sharingKey: 58, totalRevenue: "€27,340", totalSalary: "€15,857", monthRevenue: "€1,820", monthSalary: "€690", yearRevenue: "€22,340", yearSalary: "€11,170", clients: 108, rating: 4.2, services: 118, color: "from-emerald-500 to-emerald-700" },
    { id: 11, name: "Team Member 11", avatar: "W11", status: "Active", sharingKey: 52, totalRevenue: "€21,560", totalSalary: "€11,211", monthRevenue: "€1,690", monthSalary: "€820", yearRevenue: "€18,720", yearSalary: "€9,360", clients: 87, rating: 4.0, services: 95, color: "from-violet-500 to-violet-700" },
    { id: 12, name: "Team Member 12", avatar: "W12", status: "Inactive", sharingKey: 50, totalRevenue: "€18,230", totalSalary: "€9,115", monthRevenue: "€1,600", monthSalary: "€740", yearRevenue: "€16,890", yearSalary: "€8,445", clients: 72, rating: 3.9, services: 82, color: "from-fuchsia-500 to-fuchsia-700" },
];
...
const topAppointmentServices = [
    { name: "Senegalese Twists", count: 156, revenue: "€18,720", percentage: 35, color: "bg-purple-100" },
    { name: "Box Braids", count: 98, revenue: "€12,740", percentage: 25, color: "bg-pink-100" },
    { name: "Locs Maintenance", count: 87, revenue: "€7,395", percentage: 20, color: "bg-yellow-100" },
    { name: "Cornrows", count: 65, revenue: "€9,750", percentage: 12, color: "bg-orange-100" },
];
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                    {paginatedSimpleCards.length > 0 ? (
                        paginatedSimpleCards.map((worker) => (
                            <div key={worker.id} className="p-3 md:p-5 border border-purple-100 rounded-lg md:rounded-xl hover:shadow-md transition-all bg-white/80 hover:shadow-lg">
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-5 text-white shadow-lg">
                    ...
                    <p className="text-xs text-purple-200 mt-1">{activeTeam} active this month</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-2xl p-5 text-white shadow-lg">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-sm text-yellow-100">Total Salaries</span>
                    </div>
                    <p className="text-3xl font-bold">€{(totalSalary).toLocaleString()}</p>
                    <p className="text-xs text-yellow-100 mt-1">75% of revenue</p>
                </div>
                <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-5 text-white shadow-lg">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-sm text-green-100">Total Clients</span>
                    </div>
                    <p className="text-3xl font-bold">{totalClients}</p>
                    <p className="text-xs text-green-200 mt-1">+42 from last month</p>
                </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4">
                <div className="flex items-center gap-2">
                    ...
                    <select value={timeFilter} onChange={(e) => setTimeFilter(e.target.value)} className="border border-gray-200 rounded-lg px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-purple-500">
                        <option>Current Month</option><option>Last Month</option><option>Last 3 Months</option><option>This Year</option>
                    </select>
                </div>
                <div className="flex items-center gap-2">
                    <span className="text-sm text-gray-600">Status</span>
                    <select value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)} className="border border-gray-200 rounded-lg px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-purple-500">
                        <option>All Status</option><option>Active</option><option>Inactive</option>
                    </select>
                </div>
                <div className="flex items-center gap-2">
                    <span className="text-sm text-gray-600">Sort By</span>
                    <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className="border border-gray-200 rounded-lg px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-purple-500">
                            ...
                            <div className="flex items-center gap-1">
                                {Array.from({ length: totalTeamPages }, (_, i) => i + 1).map((page) => (
                                    <button
                                        ...
                                        className={`w-8 h-8 rounded-lg text-sm font-medium transition ${teamPage === page ? "bg-purple-600 text-white" : "hover:bg-gray-100 text-gray-600"}`}
                                    >
                                        {page}
                                    </button>
                                ))}
            ...
            < Card className="p-6" >
                ...
                <div className="flex justify-center gap-6 mt-4">
                    <div className="flex items-center gap-2 text-xs"><div className="w-3 h-3 rounded bg-purple-500"></div><span className="text-gray-600">Braids</span></div>
                    <div className="flex items-center gap-2 text-xs"><div className="w-3 h-3 rounded bg-pink-500"></div><span className="text-gray-600">Twists</span></div>
                    <div className="flex items-center gap-2 text-xs"><div className="w-3 h-3 rounded bg-orange-500"></div><span className="text-gray-600">Cornrows</span></div>
                    <div className="flex items-center gap-2 text-xs"><div className="w-3 h-3 rounded bg-teal-500"></div><span className="text-gray-600">Locs</span></div>
                </div>
            </Card >
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {weeklyPerformanceDetails.map((row, idx) => (
                                <tr key={idx} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-3 py-3 text-center"><TrendingUp className="w-4 h-4 text-green-500 mx-auto" /></td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                ...
                <Card className="p-6">
                    ...
                    <div className="space-y-3">
                        {dailyActivities.map((activity, idx) => (
                            <div key={idx} className={`p - 3 rounded - lg border ${activity.status === "Completed" ? "bg-green-50 border-green-100" : activity.status === "In Progress" ? "bg-blue-50 border-blue-100" : "bg-yellow-50 border-yellow-100"} `}>
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <span className={`text - xs px - 2 py - 0.5 rounded - full ${activity.status === "Completed" ? "bg-green-100 text-green-700" : activity.status === "In Progress" ? "bg-blue-100 text-blue-700" : "bg-yellow-100 text-yellow-700"} `}>{activity.status}</span>
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            < Card className="overflow-hidden" >
                <div className="flex items-center justify-between p-4 border-b border-gray-100 bg-gradient-to-r from-purple-50 to-pink-50">
                    ...
                    <Button variant="primary" size="sm" className="gap-2 bg-gradient-to-r from-orange-500 to-orange-600"><FileText className="w-4 h-4" />Export Annual Report</Button>
                </div>
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        <thead className="bg-gray-50">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {annualSummaryData.map((worker) => (
                                <tr key={worker.id} className="hover:bg-gray-50 transition">
                                    ...
                                    <td className="px-4 py-3 text-right font-semibold text-pink-600">€{worker.totalSalary.toLocaleString()}</td>
                                    <td className="px-4 py-3 text-right font-semibold text-purple-600">€{worker.salonShare.toLocaleString()}</td>
                                    <td className="px-4 py-3 text-center text-gray-900">{worker.totalClients}</td>
                                    <td className="px-4 py-3 text-center"><div className="flex items-center justify-center gap-1"><Star className="w-3 h-3 text-yellow-500 fill-yellow-500" /><span className="text-gray-900">{worker.avgRating}</span></div></td>
                                    <td className="px-4 py-3 text-right text-red-500 font-medium">€{worker.tax.toLocaleString()}</td>
                                    <td className="px-4 py-3 text-right font-bold text-green-600">€{worker.netAfterTax.toLocaleString()}</td>
                                </tr>
                            ))}
                        </tbody>
                        <tfoot className="bg-gradient-to-r from-purple-100 to-pink-100">
                            <tr className="font-bold">
                                ...
                                <td className="px-4 py-4 text-right text-pink-600">€{annualTotals.totalSalary.toLocaleString()}</td>
                                <td className="px-4 py-4 text-right text-purple-600">€{annualTotals.salonShare.toLocaleString()}</td>
                                ...
                                <td className="px-4 py-4 text-right text-green-600">€{annualTotals.netAfterTax.toLocaleString()}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="flex items-center bg-gray-100 rounded-xl p-1">
                        <button onClick={() => setViewMode("simple")} className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${viewMode === "simple" ? "bg-white text-purple-700 shadow-sm" : "text-gray-600 hover:text-gray-900"}`}>
                            <LayoutGrid className="w-4 h-4" />Simple
                        </button>
                        <button onClick={() => setViewMode("advanced")} className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${viewMode === "advanced" ? "bg-white text-purple-700 shadow-sm" : "text-gray-600 hover:text-gray-900"}`}>
