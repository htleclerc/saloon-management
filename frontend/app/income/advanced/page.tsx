...
const dailySalaryData = [
    { date: "01-01", day: "Mon", worker: "Amanda Drake", avatar: "A", service: "Haircut + Color", revenue: "€120", commission: "50%", salary: "€60", tips: "€12", total: "€72", status: "Paid" },
    { date: "01-01", day: "Mon", worker: "Sophie Martin", avatar: "S", service: "Manicure", revenue: "€45", commission: "40%", salary: "€18", tips: "€5", total: "€23", status: "Paid" },
    { date: "01-02", day: "Tue", worker: "Emma Wilson", avatar: "E", service: "Hair Treatment", revenue: "€85", commission: "45%", salary: "€38.25", tips: "€8", total: "€46.25", status: "Paid" },
    { date: "01-02", day: "Tue", worker: "Amanda Drake", avatar: "A", service: "Full Service", revenue: "€200", commission: "50%", salary: "€100", tips: "€20", total: "€120", status: "Pending" },
    { date: "01-03", day: "Wed", worker: "James Brown", avatar: "J", service: "Beard Trim", revenue: "€30", commission: "35%", salary: "€10.50", tips: "€3", total: "€13.50", status: "Paid" },
    { date: "01-03", day: "Wed", worker: "Sophie Martin", avatar: "S", service: "Pedicure", revenue: "€50", commission: "40%", salary: "€20", tips: "€6", total: "€26", status: "Pending" },
    { date: "01-04", day: "Thu", worker: "Emma Wilson", avatar: "E", service: "Haircut", revenue: "€55", commission: "45%", salary: "€24.75", tips: "€5", total: "€29.75", status: "Paid" },
];

// Weekly summary data
const weeklySummaryData = [
    { name: "Mon", revenue: 25420, salary: 12389 },
    { name: "Tue", revenue: 18350, salary: 8543 },
    { name: "Wed", revenue: 32100, salary: 15234 },
    { name: "Thu", revenue: 28450, salary: 13421 },
    { name: "Fri", revenue: 35280, salary: 16832 },
    { name: "Sat", revenue: 41200, salary: 19876 },
    { name: "Sun", revenue: 15800, salary: 7234 },
];

// Monthly summary data
const monthlySummaryData = [
    { name: "Jan", revenue: 45420, salary: 22145 },
    { name: "Feb", revenue: 52350, salary: 25687 },
    { name: "Mar", revenue: 48100, salary: 23456 },
    { name: "Apr", revenue: 55450, salary: 27123 },
    { name: "May", revenue: 61280, salary: 29845 },
    { name: "Jun", revenue: 58200, salary: 28432 },
];
...
const workerPerformanceData = [
    { name: "Amanda", revenue: 15420, salary: 7543, tips: 1234, services: 45, color: "#8B5CF6" },
    { name: "Sophie", revenue: 12350, salary: 5687, tips: 987, services: 38, color: "#EC4899" },
    { name: "Emma", revenue: 14100, salary: 6456, tips: 1123, services: 42, color: "#F59E0B" },
    { name: "James", revenue: 9450, salary: 4123, tips: 756, services: 28, color: "#10B981" },
];
...
export default function RevenusAdvancedPage() {
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div>
                        <div className="flex items-center gap-3">
                            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Daily Salary Overview</h1>
                            <span className="bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-sm font-semibold">Avancé</span>
                        </div>
                        <p className="text-gray-500 mt-1 text-sm md:text-base">Track revenue, salaries, and worker performance</p>
                    </div>
                    <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
                        <Link href="/income">
                            <Button variant="outline" size="sm" className="flex-1 md:flex-none">
                                <LayoutList className="w-4 h-4 md:mr-2" />
                                <span className="hidden md:inline">Vue Simple</span>
                            </Button>
                        </Link>
                        <Button variant="outline" size="sm" className="flex-1 md:flex-none">
                            ...
                            <div key={idx} className="p-4 hover:bg-gray-50">
                                ...
                                <div className="grid grid-cols-2 gap-2 text-sm">
                                    <div>
                                        ...
                                        <p className="font-semibold text-gray-900">{row.revenue}</p>
                                    </div>
                                    <div>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {dailySalaryData.map((row, idx) => (
                                    <tr key={idx} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-sm font-semibold text-gray-900">{row.revenue}</td>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Revenue vs Salary comparison</p>
                            </div>
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="font-semibold text-gray-900">€{worker.revenue.toLocaleString()}</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                            ...
                            <details key={idx} className="group">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-gray-900">{worker.name}</h4>
                                            <p className="text-xs text-gray-500">{worker.services} services completed</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
