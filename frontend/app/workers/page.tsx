...
const workers = [
    ...
    { id: 2, name: "Worker 2", avatar: "W2", status: "Active", sharingKey: 55, totalRevenue: "€38,650", totalSalary: "€21,258", monthRevenue: "€3,050", monthSalary: "€2,000", yearRevenue: "€41,230", yearSalary: "€22,577", clients: 156, rating: 4.8, services: 178, color: "from-pink-500 to-pink-700" },
    { id: 3, name: "Worker 3", avatar: "W3", status: "Active", sharingKey: 60, totalRevenue: "€42,200", totalSalary: "€25,320", monthRevenue: "€3,430", monthSalary: "€2,552", yearRevenue: "€38,450", yearSalary: "€33,330", clients: 165, rating: 4.7, services: 189, color: "from-orange-500 to-orange-700" },
    { id: 4, name: "Worker 4", avatar: "W4", status: "Active", sharingKey: 50, totalRevenue: "€35,420", totalSalary: "€17,710", monthRevenue: "€2,980", monthSalary: "€1,690", yearRevenue: "€34,380", yearSalary: "€17,180", clients: 142, rating: 4.6, services: 165, color: "from-teal-500 to-teal-700" },
    { id: 5, name: "Worker 5", avatar: "W5", status: "Inactive", sharingKey: 55, totalRevenue: "€28,340", totalSalary: "€15,587", monthRevenue: "€2,750", monthSalary: "€1,815", yearRevenue: "€31,200", yearSalary: "€17,160", clients: 118, rating: 4.5, services: 134, color: "from-blue-500 to-blue-700" },
    { id: 6, name: "Worker 6", avatar: "W6", status: "Active", sharingKey: 65, totalRevenue: "€39,850", totalSalary: "€25,903", monthRevenue: "€2,340", monthSalary: "€1,270", yearRevenue: "€28,980", yearSalary: "€16,685", clients: 171, rating: 4.8, services: 192, color: "from-indigo-500 to-indigo-700" },
    { id: 7, name: "Worker 7", avatar: "W7", status: "Active", sharingKey: 55, totalRevenue: "€32,450", totalSalary: "€17,848", monthRevenue: "€2,320", monthSalary: "€1,276", yearRevenue: "€28,490", yearSalary: "€14,540", clients: 124, rating: 4.6, services: 145, color: "from-rose-500 to-rose-700" },
    { id: 8, name: "Worker 8", avatar: "W8", status: "Active", sharingKey: 60, totalRevenue: "€29,870", totalSalary: "€17,922", monthRevenue: "€1,960", monthSalary: "€676", yearRevenue: "€22,340", yearSalary: "€9,170", clients: 112, rating: 4.4, services: 128, color: "from-amber-500 to-amber-700" },
    { id: 9, name: "Worker 9", avatar: "W9", status: "Inactive", sharingKey: 50, totalRevenue: "€24,680", totalSalary: "€12,340", monthRevenue: "€1,850", monthSalary: "€1,000", yearRevenue: "€24,600", yearSalary: "€13,240", clients: 98, rating: 4.3, services: 108, color: "from-cyan-500 to-cyan-700" },
    { id: 10, name: "Worker 10", avatar: "W10", status: "Active", sharingKey: 58, totalRevenue: "€27,340", totalSalary: "€15,857", monthRevenue: "€1,820", monthSalary: "€690", yearRevenue: "€22,340", yearSalary: "€11,170", clients: 108, rating: 4.2, services: 118, color: "from-emerald-500 to-emerald-700" },
    { id: 11, name: "Worker 11", avatar: "W11", status: "Active", sharingKey: 52, totalRevenue: "€21,560", totalSalary: "€11,211", monthRevenue: "€1,690", monthSalary: "€820", yearRevenue: "€18,720", yearSalary: "€9,360", clients: 87, rating: 4.0, services: 95, color: "from-violet-500 to-violet-700" },
    { id: 12, name: "Worker 12", avatar: "W12", status: "Inactive", sharingKey: 50, totalRevenue: "€18,230", totalSalary: "€9,115", monthRevenue: "€1,600", monthSalary: "€740", yearRevenue: "€16,890", yearSalary: "€8,445", clients: 72, rating: 3.9, services: 82, color: "from-fuchsia-500 to-fuchsia-700" },
];
...
export default function WorkersPage() {
            ...
            <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className="border border-gray-200 rounded-lg px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-purple-500">
                        <option>Highest Revenue</option><option>Lowest Revenue</option><option>Highest Rating</option><option>Most Clients</option>
                    </select>
                </div>
                    ...
                    <table className="w-full text-sm">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600 uppercase">Year Revenue</th>
    ...
    return (
        <WorkersLayout title="Workers Overview" description="Gérez votre équipe et suivez leurs performances">
            <div className="space-y-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex gap-3">
                        <RequirePermission role={['manager', 'admin']}>
                            <Link href="/workers/add"><Button variant="outline" size="sm"><Plus className="w-4 h-4" />Quick Add</Button></Link>
                            <Link href="/workers/add-advanced"><Button variant="primary" size="sm"><Plus className="w-4 h-4" />Complete Form</Button></Link>
                        </RequirePermission>
                    </div>
                </div>
