...
export default function AddAdvancedWorkerPage() {
    ...
    const [schedule, setSchedule] = useState<Record<string, { active: boolean; start: string; end: string }>>({
        ...
        Sam: { active: false, start: "09:00", end: "14:00" },
    ...
    const handleSubmit = () => {
        console.log("Advanced worker data:", {
        ...
        <Card>
            ...
            <div className="flex items-center gap-6 mb-6">
                ...
                <div>
                    ...
                    <Button variant="outline" size="sm">Choisir une photo</Button>
                </div>
            </div>
        ...
        <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white border-0">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/20">
                ...
                <div>
                    ...
                    <p className="text-xs text-green-100">Vérifiez les informations avant création</p>
                </div>
            </div>
    ...
    return (
        <WorkersLayout
            title="Add Worker (Advanced)"
            description="Formulaire complet pour créer un nouveau travailleur"
        >
