...
export default function InventoryPage() {
    ...
    return (
        <TeamLayout
            ...
            description="Manage salon products, prices, and stock levels"
        >
            <div className="space-y-6 pb-12">
                ...
                <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        ...
                        <Button variant="primary" className="h-11 rounded-xl shadow-lg border-none bg-gradient-to-r from-[var(--color-primary)] to-gray-900">
                                    ...
                                    <tr key={product.id} className="hover:bg-gray-50 transition-colors group">
                                            ...
                                            <div className="flex flex-col items-center gap-1">
                                                <div className="flex items-center gap-2">
                                                    <button
                                                        ...
                                                        className="w-6 h-6 flex items-center justify-center rounded bg-gray-100 text-gray-400 hover:bg-[var(--color-error-light)] hover:text-[var(--color-error)] transition-colors"
                                                    >
                                                    ...
                                                    <button
                                                        onClick={() => handleUpdateStock(product.id, product.stock, 1)}
                                                        className="w-6 h-6 flex items-center justify-center rounded bg-gray-100 text-gray-400 hover:bg-[var(--color-success-light)] hover:text-[var(--color-success)] transition-colors"
                                                    >
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <Button variant="ghost" size="sm" className="h-8 w-8 p-0 rounded-lg hover:bg-[var(--color-primary-light)] hover:text-[var(--color-primary)]">
                                                ...
                                                <Button
                                                    ...
                                                    className="h-8 w-8 p-0 rounded-lg hover:bg-[var(--color-error-light)] hover:text-[var(--color-error)]"
                                                >
