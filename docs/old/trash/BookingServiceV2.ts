...
import type { Booking, BookingWithRelations, BookingCreateData, BookingFilters, SalonWorker, Service } from '@/types';

export class BookingService extends BaseService {
    /**
     * Get all bookings for a salon
     */
    async getAll(salonId: number, filters?: BookingFilters) {
    ...
    private async checkConflicts(
        ...
        for (const booking of dayBookings) {
            ...
            const bookingWorkerIds = bookingWorkers.map((w: any) => w.id);
